...
namespace BookStore.API.Migrations
{
    ...
    [Migration("20230705072255_BookStore_UpdateAuthorsInBooks")]
    partial class BookStore_UpdateAuthorsInBooks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookStore.API.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 5, 1, 22, 54, 878, DateTimeKind.Unspecified).AddTicks(6881), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CountryOfBirth = "United States",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 5, 1, 22, 54, 878, DateTimeKind.Unspecified).AddTicks(6901), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CountryOfBirth = "United States",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 5, 1, 22, 54, 878, DateTimeKind.Unspecified).AddTicks(6906), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 5, 1, 22, 54, 878, DateTimeKind.Unspecified).AddTicks(6912), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 5, 1, 22, 54, 878, DateTimeKind.Unspecified).AddTicks(6916), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Gillian",
                            LastName = "McAllister",
                            PlaceOfBirth = ""
                        },
                        new
                        {
                            ...
                            CountryOfBirth = "",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 5, 1, 22, 54, 878, DateTimeKind.Unspecified).AddTicks(6918), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Emma",
                            LastName = "Rosenblum",
                            PlaceOfBirth = ""
                        },
                        new
                        {
                            ...
                            CountryOfBirth = "",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 5, 1, 22, 54, 878, DateTimeKind.Unspecified).AddTicks(6921), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Tracy",
                            LastName = "Wolff",
                            PlaceOfBirth = ""
                        },
                        new
                        {
                            ...
                            CountryOfBirth = "United States",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 5, 1, 22, 54, 878, DateTimeKind.Unspecified).AddTicks(6924), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Charlaine",
                            LastName = "Harris",
            ...
            modelBuilder.Entity("BookStore.API.Entities.Account.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "10ee62f0-3b79-481e-aaeb-48c8bb28ce5d",
                            ConcurrencyStamp = "3df0d72c-54de-4fcf-85cf-8763629d0503",
                            Name = "Visitor",
                            NormalizedName = "VISITOR"
                        },
                        new
                        {
                            Id = "c4b4c9b4-21bf-4566-8b14-56b192836852",
                            ConcurrencyStamp = "713f96e5-44bc-4ebf-8094-2d2a9d00efcd",
                            Name = "Administrator",
