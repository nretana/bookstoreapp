...
namespace BookStore.API.Migrations
{
    ...
    [Migration("20230705040028_BookStore_AddData")]
    partial class BookStore_AddData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookStore.API.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 4, 22, 0, 27, 820, DateTimeKind.Unspecified).AddTicks(7559), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CountryOfBirth = "United States",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 4, 22, 0, 27, 820, DateTimeKind.Unspecified).AddTicks(7572), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CountryOfBirth = "United States",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 4, 22, 0, 27, 820, DateTimeKind.Unspecified).AddTicks(7575), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 4, 22, 0, 27, 820, DateTimeKind.Unspecified).AddTicks(7580), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 4, 22, 0, 27, 820, DateTimeKind.Unspecified).AddTicks(7582), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Gillian",
                            LastName = "McAllister",
                            PlaceOfBirth = ""
                        },
                        new
                        {
                            ...
                            CountryOfBirth = "",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 4, 22, 0, 27, 820, DateTimeKind.Unspecified).AddTicks(7584), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Emma",
                            LastName = "Rosenblum",
                            PlaceOfBirth = ""
                        },
                        new
                        {
                            ...
                            CountryOfBirth = "",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 4, 22, 0, 27, 820, DateTimeKind.Unspecified).AddTicks(7587), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Tracy",
                            LastName = "Wolff",
                            PlaceOfBirth = ""
                        },
                        new
                        {
                            ...
                            CountryOfBirth = "United States",
                            DateCreated = new DateTimeOffset(new DateTime(2023, 7, 4, 22, 0, 27, 820, DateTimeKind.Unspecified).AddTicks(7590), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Charlaine",
                            LastName = "Harris",
            ...
            modelBuilder.Entity("BookStore.API.Entities.Account.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "014c5767-8c57-4e06-a6d0-27b4e0537ab2",
                            ConcurrencyStamp = "5f82ac62-ea16-46f9-a89e-d1bddd522d94",
                            Name = "Visitor",
                            NormalizedName = "VISITOR"
                        },
                        new
                        {
                            Id = "1cb60b05-4a0b-4bc7-a5ef-8ee28601fc30",
                            ConcurrencyStamp = "41d2ac23-bc90-4120-a52d-d9f48c6c9ad1",
                            Name = "Administrator",
